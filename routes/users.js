...
router.get('/profile', (req, res, next) => { console.log(req.get('Authorization'));next()},
passport.authenticate('jwt', {session: true}), user_controller.profile_detail);  // Display profile page GET
